...
interface ControlsBarModernProps {
  brands: string[];
...
export const ControlsBarModern: React.FC<ControlsBarModernProps> = ({
  brands,
  selectedBrand,
  onBrandChange,
  stockFilter,
  ...
  return (
    <div
      ref={barRef}
      className="bg-white border border-slate-200 rounded-md p-2.5 mb-3 shadow-2xs flex flex-col sm:flex-row items-center justify-between gap-2.5"
    >
      {/* Filters Group */}
      <div className="flex flex-wrap items-center gap-2 w-full sm:w-auto">
        {/* Brand Dropdown */}
        <div className="flex items-center gap-1.5">
          <label htmlFor="modern-brand-filter" className="text-xs font-medium text-slate-500">
            Brand:
          </label>
          <select
            id="modern-brand-filter"
            value={selectedBrand}
        ...
        <div className="flex items-center gap-1.5">
          <label htmlFor="modern-stock-filter" className="text-xs font-medium text-slate-500">
            Status:
          </label>
          <select
            id="modern-stock-filter"
            value={stockFilter}
        ...
        {/* Sort Dropdown */}
        <div className="flex items-center gap-1.5">
          <label htmlFor="modern-sort-select" className="text-xs font-medium text-slate-500">
            Sort:
          </label>
          <select
            id="modern-sort-select"
            value={sortBy}
...
export default ControlsBarModern;
